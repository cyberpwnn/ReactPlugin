...
public class ScreenMonitor
{
	...
	public ScreenMonitor(React react)
	{
		...
		elements.put(this.react.getSampleController().getSamplePHEntities(), new GBiset<GList<Samplable>, Integer>(new GList<Samplable>().qadd(this.react.getSampleController().getSampleDrops()).qadd(this.react.getSampleController().getSampleEntities()).qadd(this.react.getSampleController().getSampleTiles()), 3));
	}
