...
public class MathUtils
{
	...
	public static boolean isWithin(Chunk a, Chunk b, double rad)
	{
		return distanceSquared(a, b) <= rad * rad;
	}
	...
	public static double distanceSquared(Chunk a, Chunk b)
	{
		return distanceSquared(a.getBlock(0, 0, 0).getLocation(), b.getBlock(0, 0, 0).getLocation());
	}
}
