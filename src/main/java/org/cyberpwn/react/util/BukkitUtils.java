...
import org.cyberpwn.react.util.ReflectionUtil.DynamicPackage;
...
public class BukkitUtils
{
	...
	public static boolean hasUUIDSupport()
	{
		...
		else if(latest || BukkitUtils.getVersion().contains("v1_7_R3") || BukkitUtils.getVersion().contains("v1_7_R4"))
		{
			uuidSupport = true;
			return true;
		}
	...
	public static String getServerVersion()
	{
		...
		try
		{
			String dynamicPackage = "net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().substring(23, 30);
	...
	public static String getServerModName()
	{
		...
		try
		{
			...
			Object serverInstance = ReflectionUtil.getMethod(minecraftServerClass, "getServer").invoke(minecraftServerClass);
	...
	public OfflinePlayer getOfflinePlayer(String name)
	{
		...
		try
		{
			...
			Object serverInstance = getServerMethod.invoke(minecraftServerClass);
