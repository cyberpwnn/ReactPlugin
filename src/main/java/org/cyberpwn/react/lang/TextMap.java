...
import org.cyberpwn.react.util.CNum;
...
public class TextMap
{
	...
	public void check()
	{
		Dispatcher d = React.instance().getActionController().getDispatcher();
	...
	public String[] build(String s, ChatColor... c)
	{
		if(height < 0)
		{
			return null;
	...
	public String[] build(char c, ChatColor color)
	{
